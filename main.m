...
jointValue=load('Copy_of_t1.txt');%输入关节角 %A matrix of 7 x 150.Each column vector recorded the changes of each joint Angle 
[m n]=size(jointValue);
...
[res,handle_rightArmjoint1] = vrep.simxGetObjectHandle(clientID,'joint1',vrep.simx_opmode_oneshot_wait); 
[res,handle_rightArmjoint2] = vrep.simxGetObjectHandle(clientID,'joint2',vrep.simx_opmode_oneshot_wait); 
[res,handle_rightArmjoint3] = vrep.simxGetObjectHandle(clientID,'joint3',vrep.simx_opmode_oneshot_wait); 
[res,handle_rightArmjoint4] = vrep.simxGetObjectHandle(clientID,'joint4',vrep.simx_opmode_oneshot_wait); 
[res,handle_rightArmjoint5] = vrep.simxGetObjectHandle(clientID,'joint5',vrep.simx_opmode_oneshot_wait); 
[res,handle_rightArmjoint6] = vrep.simxGetObjectHandle(clientID,'joint6',vrep.simx_opmode_oneshot_wait); 
